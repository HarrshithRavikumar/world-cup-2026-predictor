...
GROUPS = {
    ...
    "L": ["Saudi Arabia", "Iran", "DR Congo", "Tunisia"],
}

CONTINENT_MAP = {
    "Spain": "Europe", "France": "Europe", "England": "Europe",
    "Germany": "Europe", "Portugal": "Europe", "Netherlands": "Europe",
    "Belgium": "Europe", "Italy": "Europe", "Switzerland": "Europe",
    "Croatia": "Europe", "Denmark": "Europe", "Serbia": "Europe",
    "Poland": "Europe", "Turkey": "Europe", "Ukraine": "Europe",
    "Austria": "Europe", "Scotland": "Europe", "Russia": "Europe",
    ...
    "Morocco": "Africa", "Senegal": "Africa", "Nigeria": "Africa",
    "Cameroon": "Africa", "Ghana": "Africa", "Egypt": "Africa",
    "Algeria": "Africa", "Tunisia": "Africa", "DR Congo": "Africa",
    "Equatorial Guinea": "Africa",
    "Japan": "Asia", "South Korea": "Asia", "Iran": "Asia",
    "Saudi Arabia": "Asia", "Australia": "Asia", "Indonesia": "Asia",
    "United States": "CONCACAF", "Mexico": "CONCACAF", "Canada": "CONCACAF",
    "Jamaica": "CONCACAF", "Panama": "CONCACAF", "Costa Rica": "CONCACAF",
    "Ireland": "Europe",
}

CONTINENT_COLORS = {
    "Europe":        "#A1C9F4",
    "South America": "#FFB8B0",
    "Africa":        "#8DE5A1",
    "Asia":          "#8FDBFF",
    "CONCACAF":      "#D0BBFF",
    "Other":         "#888888",
...
def run_simulation(n_sims, elo):
    ...
    def ko(a, b):
        return a if random.random() < exp(get(a), get(b)) else b
...
def make_win_chart(df):
    ...
    chart_df["Color"] = chart_df["Team"].map(
        lambda t: CONTINENT_COLORS.get(CONTINENT_MAP.get(t, "Other"), "#888")
    )
...
def make_polymarket_chart(df):
    ...
    for i, (_, row) in enumerate(gdf.iterrows()):
        ...
        ax.text(x, i, label, va="center", ha=ha, fontsize=8, color=TEXT)
...
st.markdown("##### Monte Carlo simulation powered by Elo ratings from historical match data")
st.divider()
...
with col1:
    ...
    st.caption(f"More sims = more accurate, but slower")
...
with col2:
    if run or "results" in st.session_state:
        ...
        with tab3:
            st.dataframe(
                results[["Team", "Win%", "Final%", "Semi%"]].style.background_gradient(
                    subset=["Win%"], cmap="YlOrRd"
                ),
        ...
        with tab4:
            elo_df = pd.Series(elo, name="Elo Rating").sort_values(ascending=False).head(40).round(1)
